...
using CreditManagementTest.Errors;
using CreditManagementTest.Infrastructure.Extensions;
...
using Address = CreditManagementTest.Entities.Address;

namespace CreditManagementTest.Seeds
{
    public class Seeder
    {
