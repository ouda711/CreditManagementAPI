...
using CreditManagementTest.Seeds;
...
namespace CreditManagementTest.Data
{
        ...
        IDesignTimeDbContextFactory<ApplicationDbContext>
    {
        ...
        public ApplicationDbContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseNpgsql("Host=localhost;Database=credit-management-database;Username=postgres;Password=1234");
...
// Cart and CartItems are stored in session, 
        public DbSet<CustomerCreditDetail> CustomerCreditDetails { get; set; }
